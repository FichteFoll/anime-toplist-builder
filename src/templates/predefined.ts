...
const predefinedTemplatePayloads: TemplateImportPayloadV1[] = [
  ...
  },
  {
    ...
    categories: [
      { id: 'winterpick01', name: 'Winter Pick', filter: { seasons: ['WINTER' as const] } },
      { id: 'springpick01', name: 'Spring Pick', filter: { seasons: ['SPRING' as const] } },
      { id: 'summerpick01', name: 'Summer Pick', filter: { seasons: ['SUMMER' as const] } },
      { id: 'fallpick01', name: 'Fall Pick', filter: { seasons: ['FALL' as const] } },
      { id: 'breakouthit01', name: 'Breakout Hit' },
      { id: 'hiddengem01', name: 'Hidden Gem', filter: { popularity: { maximum: 20000 } } },
    ],
  },
  {
    version: 1 as const,
    ...
    categories: [
      { id: 'actionspot01', name: 'Action', filter: { genres: ['Action'] } },
      { id: 'dramaspot01', name: 'Drama', filter: { genres: ['Drama'] } },
      { id: 'comedyspot01', name: 'Comedy', filter: { genres: ['Comedy'] } },
      { id: 'scifispot01', name: 'Sci-Fi', filter: { genres: ['Sci-Fi'] } },
      { id: 'romancespot01', name: 'Romance', filter: { genres: ['Romance'] } },
      { id: 'experimentaltag01', name: 'Experimental', filter: { tags: ['Experimental'] } },
    ],
  },
]
