...
<template>
  <div class="space-y-2">
    <div
      ...
      :key="`${animeId}:${song.id}`"
      class="grid w-full grid-cols-[2.5rem_1fr] items-start gap-3 rounded-[1rem] border px-3 py-3 transition"
    ...
    >
      ...
      <div class="min-w-0">
        <button
          type="button"
          class="block w-full rounded-xl text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-app-accent/60"
        ...
        >
          <span class="block min-w-0">
            ...
            <span class="mt-1 block text-xs leading-5 text-app-muted">
