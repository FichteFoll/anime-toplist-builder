...
<template>
  <PopoverRoot v-model:open="open">
    ...
    <PopoverPortal>
      <PopoverContent
        class="z-50 w-[min(96vw,72rem)] rounded-[2rem] border border-app-border/80 bg-app-surface p-5 shadow-shell"
        align="center"
        :side-offset="12"
      >
        <div class="flex flex-col gap-5 border-b border-app-border/70 pb-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
        ...
        <div class="mt-5 grid gap-3 lg:grid-cols-[minmax(0,1fr)_14rem_auto] lg:items-end">
        ...
        <div class="mt-5 min-h-72 rounded-[1.5rem] border border-app-border/70 bg-app-bg/40 p-4">
          <div
          ...
          <div
            ...
            class="flex h-full min-h-64 items-center justify-center text-center"
          >
            <p class="max-w-lg text-sm leading-6 text-app-muted">
