...
<template>
  <DialogRoot v-model:open="isOpen">
    ...
    <DialogPortal>
      ...
      <DialogContent
        class="fixed left-1/2 top-1/2 z-50 flex max-h-[90vh] w-[min(96vw,76rem)] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-[2rem] border border-app-border/80 bg-app-surface shadow-shell"
      >
        <DialogCloseButton />

        <div class="min-h-0 flex-1 overflow-y-auto px-6 py-6 sm:px-7 sm:py-7">
        ...
        <div class="border-t border-app-border/70 bg-app-surface px-6 py-4 sm:px-7">
